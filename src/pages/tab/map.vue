<template>
  <view class="page">
    ...
    <scroll-view scroll-y class="detail-scroll-view">
      ...
      <view class="panel-card section-margin-bottom">
        <view class="panel-card-title log-title">
          ...
          <text class="mock-toggle" @click="hasRecords = !hasRecords"
            >切换模拟[有/无]记录</text
          >
        </view>
        ...
        <view v-else class="record-timeline">
          ...
          <view class="record-item line-gray">
            ...
            <view class="record-body-content">
              <view class="record-header">
                ...
                <text class="record-action-link" @click="handleAction('view')"
                  >去查看</text
                >
              </view>
          ...
          <view class="record-item">
            <view class="record-icon-dot text-gray"
              ><wd-icon name="minus-circle" size="16px"
            /></view>
            <view class="record-body-content">
              <view class="record-header">
                <text class="record-status text-gray">创建任务</text>
                <text
                  class="record-action-link link-edit"
    ...
    <view class="footer-action-bar">
      <button class="primary-action-btn" @click="handleAction('completeAll')">
        全部完工
      </button>
    </view>
  </view>
