...
import { addVisitRecord } from '@/api'
...
const rateOptions = [
    { label: '非常满意', value: 'very_satisfied', activeColor: '#f97316' },
    { label: '满意', value: 'satisfied', activeColor: '#fb923c' },
    { label: '一般', value: 'normal', activeColor: '#fca5a5' },
    { label: '不满意', value: 'unsatisfied', activeColor: '#ef4444' },
]
